...
export default function DashBoardScreen(props) {
  ...
  useEffect(() => {
    const call = async () => {
      try {
        database().ref('/Temperature').on('value', (sp) => {
  ...
  return (
    <View style={{ backgroundColor: "#F5F5F5" }}>
      <View style={{
        height: deviceHeight / 4, width: deviceWidth,
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View
              ...
              <Text style={{ fontSize: 35, color: "green", marginLeft: 5, position: "relative" }}>{data !== "" && data}
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View
              ...
              <Text style={{ fontSize: 35, color: "green", marginLeft: 5, position: "relative" }}>13 <View style={{ marginBottom: 50, position: 'absolute' }}><Text style={{ fontSize: 30, color: "green" }}></Text></View><Text style={{ fontSize: 45, color: "green" }}> °C</Text></Text>
        ...
        <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View
              ...
              <Text style={{ fontSize: 25, color: "green", marginLeft: 5, position: "relative", marginBottom: 0 }}><Text>13 , </Text><Text>18 , <Text>17</Text></Text></Text>
